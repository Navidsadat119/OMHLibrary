FROM php:8.3-apache
RUN docker-php-ext-install pdo_pgsql opcache && a2enmod rewrite headers expires
...
RUN sed -ri -e 's!/var/www/html!${APACHE_DOCUMENT_ROOT}!g' /etc/apache2/sites-available/000-default.conf /etc/apache2/apache2.conf \
 && mkdir -p /var/www/html/storage /var/www/html/uploads /var/www/html/uploads/covers /var/www/html/uploads/pdfs \
